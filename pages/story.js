...
const Story = function ({textAnimationControls, handleBgColorChange, handleOpenNav, history, isNavOpen, ...rest}) {
    ...
    const [selectedTeamMember, setSelectedTeamMember] = React.useState(0);

    function openModal() {
        setModalIsOpen(true);
    }

    function teamMemberCount(j) {
        openModal();
        setSelectedTeamMember(j);
    }
    ...
    const getTeamMembers = () => {
        ...
        while (i <= numberOfMembersImage) {
            teamMembers.push(
                <div className={styles.gridItem} id={i} key={`teamMember.${i}`} onClick={(e) => {
                    teamMemberCount(e.target.id);
                } }>
                    <img
                        id={i}
    ...
    return (
        <>
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            {/*        <motion.img src="/Story.png" height="341px" width="900px" layout="fixed"*/}
                ...
                <TeamModal isOpen={modalIsOpen} onClose={closeModal} selectedTeamMember={selectedTeamMember}/>
            </motion.div>
            <Footer/>
        </>
    );
